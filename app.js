...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var message2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + totalProduct + '.';

  return [totalSum, totalProduct, message1, message2];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var message = testArray + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.';
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var message = 'The numbers ' + multArr + ' have a product of ' + totalProduct + '.';
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  firstProduct = multiply(dynamicArray[0], dynamicArray[1])[0];
  for(var i = 2; i < dynamicArray.length; i++) {
    firstProduct = multiply(firstProduct, dynamicArray[i])[0];
  }

  var message = 'The numbers ' + dynamicArray + ' have a product of ' + firstProduct + '.';

  return [firstProduct, message];
}
