...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var message = `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${secondSum} is their sum.`;
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var message = `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${secondProduct}.`;
